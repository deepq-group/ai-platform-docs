...
* [2. Dataset](dataset/README.md)
  ...
  * [2.3 Upload Dataset](dataset/2.3-upload-dataset/README.md)
    * [Dataset Check tool](dataset/2.3-upload-dataset/dataset-check-tool.md)
    * [Upload from My computer](dataset/2.3-upload-dataset/upload-from-my-computer.md)
    * [Upload from Host Server](dataset/2.3-upload-dataset/upload-from-host-server.md)
  ...
  * [2.6 Combine Datasets](dataset/2.6-combine-datasets/README.md)
    * [1. Select Datasets](dataset/2.6-combine-datasets/1.-select-datasets.md)
    * [2. Select Annotation Types](dataset/2.6-combine-datasets/2.-select-annotation-types.md)
    * [3. Review & Combine](dataset/2.6-combine-datasets/3.-review-and-combine.md)
