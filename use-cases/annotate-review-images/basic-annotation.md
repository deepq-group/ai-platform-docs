...
![](../../.gitbook/assets/DeepCap_Jobs_Overview_Ongoing.png)
...
![](../../.gitbook/assets/DeepCap_Jobs_Detail_1.png)
...
![](../../.gitbook/assets/DeepCap_Jobs_Detail_2.png)
...
![](../../.gitbook/assets/DeepCap_Jobs_AnRe_1.png)
...
![](../../.gitbook/assets/DeepCap_Jobs_AnRe_2.png)

* You can view the WW/WL of that image by the top left button, select it to adjust the WW/WL of the image.
* Click on ![](../../.gitbook/assets/icon_magnify.png) and slide to zoom in and zoom out the images.

![](../../.gitbook/assets/DeepCap_Jobs_AnRe_3.png)
...
Once you click on the review job assigned to you, the necessary review job information can be found in this overview page: review progress in terms of # of jobs left & completion percentage, method & labels and the project owners instructions and all review jobs and their respective status listed below.

![](../../.gitbook/assets/DeepCap_Jobs_AnRe_4.png)

All assigned studies that have been annotated/submitted by annotators and waiting to be reviewed will appear on the list at the bottom.

![](../../.gitbook/assets/DeepCap_Jobs_AnRe_5.png)

### Annotation Review <a href="#annotation-review" id="annotation-review"></a>

![](../../.gitbook/assets/DeepCap_Jobs_AnRe_6.png)
